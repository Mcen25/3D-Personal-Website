...
const NavBar: FC<NavBarProps> = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-[rgb(17,17,17)]/75 py-2">
    <div className="w-[60%] mx-auto relative">
      ...
      <div
        className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[60%] border-b-2 border-gray-500"
        style={{ bottom: '-2px' }}
      />
    </div>
  );
